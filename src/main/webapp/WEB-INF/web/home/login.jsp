					...
					<form name="register">
						...
						<div class="form_row">
							...
							<input id="password" name="password"
								type="password" class="contact_input" />
						</div>
						
						<div class="form_row">
                        <div class="terms">
                        	<input type="radio" name="terms" checked  value="0"/>用户
                        	<input type="radio" name="terms" value="1"/>商家	
                        </div>
                    </div> 
						
						<div class="form_row">
							<input type="button" class="register" value="login" onclick="login()"/>
						</div>
		...
		<div class="right_content">
			<div class="languages_box">
				<span class="red">Languages:</span> <a href="#" class="selected"><img
					...
					border="0" /></a> <a href="#"><img src="${ctx}/home/images/de.gif"
					alt="" title="" border="0" /></a>
			</div>
			<div class="currency">
